...
class CustomMetadataTest(TestCase):
    ...
    def test_metadata_loader_valid(self):
        """Test that setting DBBACKUP_CUSTOM_METADATA_LOADER works."""
    ...
    @override_settings(DBBACKUP_CUSTOM_METADATA_VALIDATOR="non.existent.validator")
    ...
    @override_settings(DBBACKUP_CUSTOM_METADATA_VALIDATOR="tests.test_custommeta.broken_validator")
