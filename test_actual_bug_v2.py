...
try:
    ...
    if '/tmp/default.db' in processed_databases and '/tmp/secondary.db' not in processed_databases:
        print("❌ BUG CONFIRMED: 'default' database was backed up instead of 'secondary'")
    elif '/tmp/secondary.db' in processed_databases and '/tmp/default.db' not in processed_databases:
