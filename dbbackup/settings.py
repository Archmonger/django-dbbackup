...
CUSTOM_METADATA_LOADER = getattr(settings, "DBBACKUP_CUSTOM_METADATA_LOADER", None)
CUSTOM_METADATA_VALIDATOR = getattr(settings, "DBBACKUP_CUSTOM_METADATA_VALIDATOR", None)
